...
if(isset($_GET['act']) && $_GET['act']=='date' && $_POST['select2'] != "all" && $_POST['select3'] != "all")
{
$date=$_POST['date'];
$date2=$_POST['date2'];
...
$sql3="select * from time_table where date >= '$date' && date <= '$date2' && status = '$select2' &&  type = '$select3'";
$result3=mysql_query($sql3);
}

elseif(isset($_GET['act']) && $_GET['act']=='date' && $_POST['select2'] != "all" && $_POST['select3'] == "all")
{
$date=$_POST['date'];
$date2=$_POST['date2'];
$select2=$_POST['select2'];
...
$select3=$_POST['select3'];
		...
		$sql3="select * from time_table where date >= '$date' && date <= '$date2' && type = '$select3'";
$result3=mysql_query($sql3);
...
<th><input name="date" type="text" class="loginput" id="email" value="2000-00-00" /></th>
<th>to</th>
<th><input name="date2" type="text" class="loginput" id="email" value="3000-00-00" /></th>
<th>yyyy-mm-dd</th>
...
<th>Only show£º</th>
  ...
  <td height="0"><label>
      Section :<select name="select3"><option>all</option><option value="A">A</option><option>B</option></select>
 ...
 <th></th>
    ...
    <td height="0"><label>
      Status :<select name="select2"><option>all</option><option value="authorized">authorized</option><option>pending</option><option>denied</option></select>
